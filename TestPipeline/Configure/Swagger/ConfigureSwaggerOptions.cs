...
namespace TestPipeline.Configure.Swagger
{
        ...
        : IConfigureNamedOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipeline.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipeline.Domain.xml"));
